...
The slider is simulated as a digital input (GPIO) that triggers an interrupt when pushed. This sends an immediate SOS packet via Bluetooth to the paired device.
 ...
 6. Contributions- Team Code Mates
 [Gunjan, Taniya, Yogita, Khushi]: Project Ideation, UI Prototyping, and Research Documentation.
  
  7. Future Scope
 *AI Integration: Using Machine Learning to detect "Scream" patterns or unusual movements via the phone's microphone/sensors.
 *Smart City Integration: Connecting with the city's smart surveillance cameras to provide live feeds during emergencies.
 *Wearable Variants: Designing the hardware as a smart ring or watch-strap module.
